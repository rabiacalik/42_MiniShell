...
#include "minishell.h"
/*
	bir komutun içinde geçen bir çevresel değişkenin değrini almak için kullanılır
	ilk karakter "?" ise exit_status u stringe çevirip döndürür
	|<>"'$= karakterlerini görene kadarki kısmı çevresel değişken ismi olarak belirler
	"find_in_env_variables" ile çevresel değişken listesinde arar ve değerini Var_value kaydeder
	durumları kontrol ederek değer döndürür
*/
...
/*
	belirtilen işaretlerden sonraki indexi döndürür
	bir sonraki komuta geçer
*/
...
/*
	dolar işareti ike başlayan karakterlerin uzunluğunu hesaplar
	bunlar genellikle shell ortam degişkenleri olur
*/
...
/*
	dolar işareti ile başlayan ifadeleri çevresel değişkenlere karşılık gelen
	değerlerle değiştirerek yeni bir karakter dizisi oluşturur
*/
