...
/*
	string içerisindeki set değerlerini baştan sona kaldırır
	ve temizlenmiş halinin uzunluğunu geriye döndürür
*/
...
/*
	stringin uzunluğunu döner ve stringin alanını boşaltır
*/
