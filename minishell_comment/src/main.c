...
/*
	env lere yer ayırır
	isim verir (= dir den öncesi)
	valu e ye değerleri atanır getenv ile
	add_env_to_list ile diğer env ye geçer 
...
/*
	bin/.heredoc_temp var olup olmama durumuna göre
	komut satırının temizlenmesi, imlecin yeni satıra taşınması,
	yeni girdi beklenildiğinin belirtilmesi gibi şeyler yapar
*/
...
int	main(int argc, char **argv, char **envp)
{
	...
	signal(SIGQUIT, SIG_IGN); //kullanıcı çıkışını ignore et
	init_global_shell();
