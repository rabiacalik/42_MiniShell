...
/*
	tokenlerı sayar ve sonuvu geriye döner
*/
...
/*
	yeni token ekler
	başta token yoksa eklenen direkt olarak baştaki olarak eklenir 
*/
...
/*
	token->value değerinin ilk indexi tek yada çift tırnak ise
	bu değeri tırnakları kaldılmış şekilde değiştirip token->quote_check değerini 1 yapar
*/
